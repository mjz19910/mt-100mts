require = function(str, real) return real end
local Big = dofile(minetest.get_modpath("mts_bignumber").."/bignumber.lua")
local PickaxeGenerator = dofile(minetest.get_modpath("mts_pickcrafting").."/PickaxeGenerator.lua")
local Formatter = dofile(minetest.get_modpath("mts_formatter").."/Formatter.lua")
